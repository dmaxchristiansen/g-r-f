...
class User(models.Model):
    ...
    prof_pic = models.FileField(upload_to='images/', default='images/default-icon.png')
    url = models.TextField(default="https://static.thenounproject.com/png/629576-200.png")
